...
public class SelfClassLoader {
    public static void main(String[] args) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ClassLoader myClassLoader = new ClassLoader() {
            ...
            // 主要这里的findClass其实没有用到，因为加载 SelfClassLoader 类是在AppClassLoader完成的;
...
//            }
        ...
        Object obj = myClassLoader.loadClass("top.luobogan.JVM.classLoader.SelfClassLoader").newInstance();
        System.out.println(obj.getClass()); //com.boot.jvm.SelfClassLoader

//        System.out.println(obj // top.luobogan.JVM.SelfClassLoader
//                instanceof com.boot.jvm.SelfClassLoader);
    }
}
