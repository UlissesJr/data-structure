...
//            }
        ...
        Object obj = myClassLoader.loadClass("top.luobogan.JVM.SelfClassLoader").newInstance();
        System.out.println(obj.getClass()); //top.luobogan.JVM.SelfClassLoader

        System.out.println(obj // top.luobogan.JVM.SelfClassLoader
                instanceof top.luobogan.JVM.SelfClassLoader);
    }
